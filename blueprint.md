...
| 6 | Administración de servicios | #2, #5 | CRUD de servicios con categoría, país, precio orientativo, estado draft/publicado |
| 7 | Constructor de formularios | #6 | Editor drag-and-drop de campos (text, select, date, file); schema JSON guardado por servicio |
| 8 | Catálogo de servicios | #2, #6 | Lista pública filtrable por categoría y país; paginación; SSR |
